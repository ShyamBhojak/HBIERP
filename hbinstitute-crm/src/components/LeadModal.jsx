    ...
    <div className="fixed inset-0 z-[100] bg-black/95 flex items-center justify-center p-4">
      <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 w-full max-w-xl rounded-[3rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="p-8 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-white dark:bg-gray-950">
          ...
          <button onClick={closeLeadModal} className="p-3 bg-gray-800 hover:bg-red-500/20 text-gray-400 hover:text-red-500 rounded-2xl transition-all"><X /></button>
        </div>
        <form onSubmit={handleSaveLead} className="p-8 space-y-6 overflow-y-auto max-h-[75vh]">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest px-2">Interest Course</label>
            <select className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl px-6 py-4 focus:ring-2 focus:ring-indigo-600 appearance-none cursor-pointer outline-none" value={newLead.course} onChange={e => setNewLead({ ...newLead, course: e.target.value })}>
