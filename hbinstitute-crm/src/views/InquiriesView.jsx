    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {filteredLeads.map(lead => {
          ...
          // COMPATIBILITY FALLBACK: Ensure courses array parameter exists cleanly
            ...
            <div key={lead.id} className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-[2rem] p-6 hover:border-gray-700 transition-all shadow-sm">
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-gray-500 items-center">
                    ...
                    {/* NEW: Displays Multiple Course Badge Chips Side-by-Side */}
                    <div className="flex flex-wrap gap-1">
                      {leadCourses.map((c, i) => (
                        <span key={i} className="px-2 py-0.5 bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-bold text-[10px] rounded-md uppercase tracking-wide border border-gray-300/30">
                          {c}
                        </span>
                      ))}
                    </div>
