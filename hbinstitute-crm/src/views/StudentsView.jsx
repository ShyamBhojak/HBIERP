                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-1">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-950 border border-gray-100 dark:border-gray-800/80 p-3.5 rounded-2xl space-y-1.5">
                        ...
                        <div>
                          <p className={`text-sm font-black ${outstandingBalance <= 0 ? 'text-green-500' : 'text-gray-800 dark:text-gray-200'}`}>{outstandingBalance <= 0 ? `₹${totalCourseFee.toLocaleString('en-IN')}` : `₹${paidInstallments.toLocaleString('en-IN')}`}<span className="text-[10px] text-gray-400 font-normal"> Paid</span></p>
