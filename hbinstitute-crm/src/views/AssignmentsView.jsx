              ...
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 justify-between">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-4 text-[11px] text-gray-400 font-bold pt-2">
                    ...
                    <span className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400"><Calendar size={13} /> Assigned: {task.givenDate ? task.givenDate.split('-').reverse().join('/') : 'N/A'}</span>
                    <span className="flex items-center gap-1.5 text-red-500"><Calendar size={13} /> Deadline: {task.dueDate ? task.dueDate.split('-').reverse().join('/') : 'N/A'}</span>
                    <span className="flex items-center gap-1.5"><BookOpen size={13} /> Targeted: {courseStudents.length} Students</span>
                  </div>
                </div>
                    ...
                    return (
                      <div key={std.id} className="flex items-center justify-between bg-gray-50 dark:bg-gray-950 p-3 rounded-xl border border-gray-100 dark:border-gray-800/60">
                        ...
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-wider transition-all flex items-center gap-1 ${submissionStatus === 'Completed'
