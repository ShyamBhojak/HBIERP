...
import { Award, Download, CheckSquare, DollarSign, User, BookOpen, Calendar, LogOut, Clock } from 'lucide-react';
...
const StudentPortal = ({ user, studentProfileProp }) => {
  ...
  // 1. Fetch Student Profile Based on Authenticated Google Email
  // useEffect(() => {
  ...
  //         setStudentProfile({ id: querySnapshot.docs[0].id, ...querySnapshot.docs[0].data() });
  //       }
  //     } catch (err) {
  ...
  // 2. Real-time Database Event Stream Subscriptions
  useEffect(() => {
  ...
  // 3. Compute Metrics matching Admin View Logic
  ...
  // Re-use the exact beautifully formatted master billing print system from Admin ERP
        ...
        <head>
          ...
          <style>
            ...
            * { box-sizing: border-box; font-family: 'Inter', sans-serif; margin: 0; padding: 0; }
            ...
            /* Add this snippet directly inside the template style block */
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-6 text-gray-800 dark:text-gray-100 min-h-screen font-sans">
      ...
      {/* 3. Chronological Classroom Syllabus Log Timeline */}
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-[2.5rem] p-6 md:p-8 shadow-sm animate-in fade-in duration-500">
        ...
        {sessionUpdates.length > 0 ? (
          <div className="relative border-l-2 border-gray-100 dark:border-gray-800 ml-3 pl-6 space-y-6">
